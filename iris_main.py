...
def main(args):
    np.random.seed(42)
    X, Y = H.DataBase("data/iris.data").load_iris()
    X, Y = H.shuffle(X, Y)
    ...
    net = MyNetwork(trainX, trainY, param_path=args.param_dir, \
...
if __name__ == "__main__":
    ...
    parser.add_argument("--param_dir",       type=str,   default="my_network/my_params/iris_prm.txt")
